...
class _$AuthStateImpl implements _AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(isLoading: $isLoading, isAuthenticated: $isAuthenticated, user: $user, error: $error, isBiometricEnabled: $isBiometricEnabled, isBiometricAvailable: $isBiometricAvailable)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, isLoading, isAuthenticated, user,
      error, isBiometricEnabled, isBiometricAvailable);
...
abstract class _AuthState implements AuthState {
  const factory _AuthState(
      ...
      final String? error,
      final bool isBiometricEnabled,
      final bool isBiometricAvailable}) = _$AuthStateImpl;
